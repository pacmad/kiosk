...
@section('main')
    <div class="grid">
        @foreach($godparenthoods as $index => $godparenthood)
            @if ($index % 2 == 0)
                <div class="grid__item grid__half-first">
                    <article class="card">
                        <figure class="card__figure">
                            <span class="card__icon">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 548.169 548.169" style="enable-background:new 0 0 548.169 548.169;"xml:space="preserve" fill="#000">
                                    <g>
                            ...
                            <span class="card__icon-text">
                                <span class="card__something-todo">{{$godparenthood->children->count()}}</span>
                                Kinder
                            </span>
                        </figure>
                        <p class="card__content">{{ $godparenthood->title }}</p>
                        <a class="card__link" href="{{action('GodparenthoodController@show', ['godparenthood' => $godparenthood])}}">
                            {{ $godparenthood->title }}
                        </a>
                    </article>
                </div>
            @else
                <div class="grid__item grid__half-second">
                    <article class="card">
                        <figure class="card__figure">
                            <span class="card__icon">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 548.169 548.169" style="enable-background:new 0 0 548.169 548.169;"xml:space="preserve">
                                    <g>
                                        <path d="M109.634,164.452c20.179,0,37.402-7.135,51.674-21.411c14.277-14.275,21.416-31.503,21.416-51.678
                                            c0-20.173-7.139-37.401-21.416-51.678c-14.272-14.275-31.496-21.414-51.674-21.414c-20.177,0-37.401,7.139-51.676,21.414
                                            C43.684,53.962,36.545,71.186,36.545,91.363c0,20.179,7.139,37.403,21.413,51.678C72.233,157.313,89.457,164.452,109.634,164.452z
